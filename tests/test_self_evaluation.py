...
def test_cort_session_with_self_evaluation_prefer_new(mock_template_manager, mock_config):
...
def test_cort_session_with_self_evaluation_prefer_previous(mock_template_manager, mock_config):
...
def test_cort_session_multiple_rounds_with_self_evaluation(mock_template_manager, mock_config):
