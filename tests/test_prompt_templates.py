...
@pytest.mark.parametrize(
    ...
    [
        ...
        ("alternative_prompt.j2", {"question": "Test question", "current_answer": "Current answer"}, 
         "Current answer"),
        ("evaluation_prompt.j2", {
...
def test_template_rendering(template_name, context, expected_substring):
    ...
    assert expected_substring in rendered, f"Expected '{expected_substring}' in rendered template"
...
def test_custom_template_directory():
    ...
    with TemporaryDirectory() as temp_dir:
        ...
        rendered = manager.render_template("custom_template.j2", {"variable": "test value"})
...
def test_all_template_contexts():
    ...
    initial = manager.render_template("initial_prompt.j2", {"question": "Test question"})
